...
if("TRUE" STREQUAL "TRUE")
  set(ball_chaser_SOURCE_PREFIX /home/nvidia/project2/project2/cakin_ws/src/ball_chaser)
  set(ball_chaser_DEVEL_PREFIX /home/nvidia/project2/project2/cakin_ws/devel)
  ...
  set(ball_chaser_INSTALL_PREFIX /home/nvidia/project2/project2/cakin_ws/install)
...
if(NOT "/home/nvidia/project2/project2/cakin_ws/devel/include " STREQUAL " ")
  set(ball_chaser_INCLUDE_DIRS "")
  set(_include_dirs "/home/nvidia/project2/project2/cakin_ws/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ball_chaser' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/project2/project2/cakin_ws/src/ball_chaser/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/nvidia/project2/project2/cakin_ws/devel/lib;/home/nvidia/project2/project2/cakin_ws/devel/lib;/home/nvidia/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
